...
beam_data = pd.read_csv("Beam3.dat")
...
# %% Perforn Calculation
# use polyfiti to get coefficients
...
ax.set(
    ...
    title = "Displacement vs. Force for Beam3.dat (cgd19 )",
) 
...
#%%% get the values we need in the proper notation
...
compliance = 0.00241634
init_disp = 0.00058703
